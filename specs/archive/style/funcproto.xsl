...
<xsl:template name="get-prefix">
    ...
    <xsl:choose>
      ...
      <xsl:when test="ancestor-or-self::*[@prefix][1]/@prefix = 'bin'">bin:</xsl:when>
      <xsl:when test="ancestor-or-self::*[@prefix][1]/@prefix = 'arch'">arch:</xsl:when>
      <xsl:when test="ancestor-or-self::*[@prefix][1]/@prefix = 'archM'">archM:</xsl:when>
